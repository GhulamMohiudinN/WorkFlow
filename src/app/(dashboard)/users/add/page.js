...
export default function AddUserPage() {
  ...
  const rolePermissions = {
    admin: {
      description: "Full access to manage users, processes, and company settings",
                          ...
                          >
                            <div className="flex items-center mb-2">
                              <div className={`h-3 w-3 rounded-full mr-2 ${
                                formData.role === role ? 'bg-amber-500' : 'bg-gray-300'
                              }`}></div>
                    ...
                    {Object.entries(formData.permissions).map(([key, value]) => (
                      <div
                        ...
                        className={`flex items-center p-4 border rounded-lg cursor-pointer transition-all duration-200 ${
                          value ? 'border-amber-500 bg-amber-50' : 'border-gray-300'
                        }`}
                      ...
                      >
                        <div className={`flex-shrink-0 w-5 h-5 rounded-full border flex items-center justify-center mr-3 ${
                          value ? 'border-amber-500 bg-amber-500' : 'border-gray-400'
                        }`}>
