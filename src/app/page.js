  ...
  const testimonials = [
    {
      ...
      content:
        "WorkflowPro reduced our process setup time by 70%. The AI suggestions are game-changing.",
    ...
    },
    {
      ...
      content:
        "From onboarding to approvals, everything runs smoothly. Team collaboration has never been easier.",
      company: "Enterprise",
    },
    {
      name: "Priya Sharma",
      ...
      content:
        "The perfect balance of simplicity and power. Our small team manages like an enterprise.",
      company: "Startup",
    },
  ];
          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <span className="text-xs text-amber-600 font-medium ml-2 bg-amber-100 px-2 py-0.5 rounded">
                  BETA
                </span>
              </div>
            </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                Create, automate, and optimize your company`s processes in one
                secure platform. From team onboarding to complex approval
                systems—everything managed in your private workspace.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              From small teams to large enterprises, WorkflowPro provides the
              tools to manage your entire operation.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            {features.map((feature, index) => (
              <div
                key={index}
                className="group p-6 rounded-2xl border border-gray-200 hover:border-amber-300 hover:shadow-lg transition-all duration-300"
              >
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <h3 className="text-2xl font-bold text-gray-900 mb-4">
                Visualize, Build, Execute
              </h3>
              <p className="text-gray-600 mb-6">
                Create complex workflows with our intuitive drag-and-drop
                builder. Map out every step, assign tasks, and set
                conditions—all without writing a single line of code.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {[
              {
                ...
                desc: "Sign up with your company email",
                icon: <FiBriefcase />,
              },
              {
                number: "02",
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="order-2 lg:order-1">
              ...
              <p className="text-gray-600 mb-6">
                Our AI analyzes your workflows and suggests optimizations,
                automations, and improvements. It learns from your team`s
                patterns to make your processes more efficient over time.
              </p>
              <div className="space-y-4">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Spot bottlenecks and improvement areas
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-gray-600 mb-6">
                Whether your team is in the office, remote, or hybrid,
                WorkflowPro keeps everyone connected. Real-time updates,
                collaborative editing, and seamless communication built right
                in.
              </p>
      ...
      <section className="py-20 bg-linear-to-r from-amber-500 to-amber-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-amber-100 text-lg mb-8 max-w-2xl mx-auto">
            Join thousands of companies that trust WorkflowPro to manage their
            critical processes.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-sm">
                Enterprise workflow management platform powered by AI and
                MongoDB.
              </p>
            </div>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-sm text-center">
            ...
            <p className="mt-2">
              Built with MongoDB • Enterprise-ready • SOC 2 Type II Certified
            </p>
          </div>
        </div>
      </footer>
